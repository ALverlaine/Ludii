...
public class PutCard extends BaseAction {
     ...
     */
    public PutCard(final String detailedString)
    {
        assert (detailedString.startsWith("[PutCard:"));
    ...
    public boolean equals(final Object obj)
    {
        ...
        if (!(obj instanceof PutCard))
            return false;

        final PutCard other = (PutCard) obj;
