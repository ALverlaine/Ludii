package other.action.move.cardMove;
...
/*
Draw a card from somewhere
 */

public class DrawCard extends BaseAction {
     ...
     */
    public DrawCard(final String detailedString)
    {
        assert (detailedString.startsWith("[DrawCard:"));
    ...
    public boolean equals(final Object obj)
    {
        ...
        final DrawCard other = (DrawCard) obj;
